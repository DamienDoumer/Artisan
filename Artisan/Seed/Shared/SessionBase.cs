...
namespace Seed.Shared
{
    public class SessionBase : IDisposable
    {
        ...
        /// <summary>
        /// Fired when this session receives a message which has to be encrypted
        /// </summary>
        ...
        public delegate void AuthenticationObjectReceivedEventHanlder(AuthenticationObject obj, Session session);
        /// <summary>
